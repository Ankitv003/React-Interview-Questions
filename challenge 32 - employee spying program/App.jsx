...
export default function App() {
  ...
  function handleChange(e){
    ...
    setUserInput(mainValue.replace("Evil Corp.","Good Corp." ))
    
    setTrackingReports(prevData=>([...prevData,
    {
       timeStamp :getTimeStamp(),
       employeeInput: mainValue,
       infractionDetected: mainValue.includes("Evil Corp.")
    }]))
  }
/* Challenge 
