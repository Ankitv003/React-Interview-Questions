...
export default function App() {
    ...
    // console.log(currentData.image.quoteFontSize)
...
const smallestFont=getSmallestFontSize(currentData.image.quoteFontSize,currentData.text.quoteFontSize)
// console.log(currentData.image.quoteFontSize,currentData.text.quoteFontSize)
// console.log(smallestFont)
    return (
        <div className="wrapper" style={currentData.image.wrapperStyles}>
            <div className="quote-container" style={currentData.image.containerStyles}>
                <p className="quote" style={smallestFont}>
