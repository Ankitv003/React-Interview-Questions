...
/* Challenge:
  ...
  */
	...
	return (
		<div onMouseUp={toggle} className={`wrapper ${torchEquipped && "relative no-cursor"}`}>
			<div className={`game-area ${!torchEquipped && "relative"}`}>
				...
				<div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={`wood-container ${kindleClass}`}>
					🪵
